...
from app.services.user_dao import delete_user_by_id
    ...
    while True:
        ...
        if user_input == '1':
            ...
            try:
                ...
                confirm = input(colored(f'Are you sure you want to delete user with ID {user_id}? (y/n): ', 'red'))
                if confirm.lower() == 'y':
    ...
    while True:
        ...
        if user_input == '1':
            ...
            try:
                ...
                print(colored('Sale order completed successfuly','green'))
            except Exception as e:
                print(colored(f'Could not complete sell order: {e}', 'red'))
