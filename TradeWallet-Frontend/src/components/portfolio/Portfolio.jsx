...
import Navbar from '../navigation/Navbar'; // Import the common Navbar component
import '../../styles/portfolio.css'; // Import the associated styling

const Portfolio = () => {
    return (
        <>
            <Navbar /> {/* Include the common Navbar */}
